            ...
            if (connex == 0):
                ...
                if self.ModeAuto:
                    if Devices[4].sValue == "30":
                        Domoticz.Debug("Mode OK in AutoMode")
                    and if Devices[5].sValue == "10":
                        Domoticz.Debug("FanSpeed OK in AutoMode")
                    and if Devices[6].sValue == Devices[10].sValue:
                         Domoticz.Debug("Setpoint OK in AutoMode")
                    else :
    ...
    def onHeartbeat(self):
        ...
        if self.powerOn :
            ...
            #self.setpoint = (float(Devices[10].sValue) - 2)
                ...
                Devices[6].Update(nValue = self.powerOn,sValue = (Devices[10].sValue))  # Thermostat setpoint = AC setpoint

            elif self.ModeManual :
                Devices[9].Update(nValue = self.powerOn,sValue = "30")
                Devices[10].Update(nValue = self.powerOn,sValue = (Devices[6].sValue))  # AC setpoint = Thermostat setpoint
        else :
            Devices[9].Update(nValue = self.powerOn,sValue = "10")
